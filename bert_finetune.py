...
class HackProcessor(DataProcessor):
...
def main():
    ...
    if args.do_eval:
        ...
        eval_dataloader = DataLoader(dataset=HackData(eval_examples, label_list, args.max_seq_length, tokenizer), batch_size=args.eval_batch_size)
    ...
    if args.do_train:
        ...
        train_dataloader = DataLoader(dataset=HackData(train_examples, label_list, args.max_seq_length, tokenizer), batch_size=args.train_batch_size)
